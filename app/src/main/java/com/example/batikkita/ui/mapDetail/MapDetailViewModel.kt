...
class MapDetailViewModel(private val mBatikRepository: BatikRepository) : ViewModel() {
    fun getDetailIsland(origin: String): LiveData<IslandEntity> =
        mBatikRepository.getDetailIsland(origin)

    fun getListIslandBatik(origin: String): LiveData<List<BatikEntity>> =
        mBatikRepository.getListIslandBatik(origin)

    fun getListIslandExceptBatik(origin: String): LiveData<List<BatikEntity>> =
        mBatikRepository.getListIslandExceptIslandBatik(origin)
